    ...
    public partial class TinderEF : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CurrentUserLikes", x => new { x.CurrentUserId, x.LikesId });
                    table.ForeignKey(
                        name: "FK_CurrentUserLikes_CurrentUser_CurrentUserId",
                        column: x => x.CurrentUserId,
                        principalTable: "CurrentUser",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_CurrentUserLikes_Likes_LikesId",
                        column: x => x.LikesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CurrentUserLikes_LikesId",
                table: "CurrentUserLikes",
                column: "LikesId");
